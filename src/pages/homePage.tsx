          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                ...
                <li><a href="https://tecxzo.info/" className="hover:text-white transition-colors">Tecxzo</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                ...
                <li><Link to="/termsandcondition" className="hover:text-white transition-colors">Terms of Service</Link></li>
                <li><Link to="/datadeletion" className="hover:text-white transition-colors">Data Deletion</Link></li>
              </ul>
            </div>
          </div>
